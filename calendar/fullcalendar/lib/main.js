    ...
    */
    ...
    var ListViewHeaderRow = /** @class */ (function (_super) {
        ...
        ListViewHeaderRow.prototype.render = function () {
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.dayHeaderClassNames,
                content: options.dayHeaderContent, defaultContent: renderInnerContent$4,
              ...
              { return (createElement("tr", { ref: rootElRef, className: classNames.concat(customClassNames).join(' '), "data-date": formatDayString(dayDate) },
                // createElement("th", { colSpan: 4 },
                  createElement("td", { className: 'fc-list-day-cushion ' + theme.getClass('tableCellShaded'), ref: innerElRef }, innerContent),
                  createElement("td", { className: 'fc-list-day-cushion ' + theme.getClass('tableCellShaded'), ref: innerElRef }, ''),
                  createElement("td", { className: 'fc-list-day-cushion ' + theme.getClass('tableCellShaded'), ref: innerElRef }, ''),
                  createElement("td", { className: 'fc-list-day-cushion day-cushion-right text-center ' + theme.getClass('tableCellShaded'), ref: innerElRef }, 'Фото'))); }));
        };
    ...
    var ListViewEventRow = /** @class */ (function (_super) {
        ...
        ListViewEventRow.prototype.render = function () {
            ...
            return (createElement(EventRoot, { seg: seg, timeText: "" // BAD. because of all-day content
                ...
                defaultContent: renderEventInnerContent, isPast: props.isPast, isFuture: props.isFuture, isToday: props.isToday, isSelected: props.isSelected, isDragging: props.isDragging, isResizing: props.isResizing, isDateSelecting: props.isDateSelecting },
              function (rootElRef, classNames, innerElRef, innerContent, hookProps) {
                ...
                createElement("td", { className: "fc-list-event-graphic" },
                  ...
                  createElement("span", { className: "fc-list-event-dot", style: { borderColor: seg.eventRange.def.extendedProps.colorBackground } })),
                createElement("td", { className: "fc-list-event-title", ref: innerElRef }, innerContent),
            createElement("td", { className: "fc-list-event-title photo__count text-center",
                style: {backgroundColor:seg.eventRange.def.extendedProps.colorBackground}, ref: innerElRef },
                seg.eventRange.def.extendedProps.count))); }));
